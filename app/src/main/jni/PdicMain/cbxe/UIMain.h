...
private:
	TUIMain(TPdicMain *main, IWordEdit *edit, TListBox *listBox);
public:
	virtual ~TUIMain();
	static TUIMain *CreateInstance(TPdicMain *main, IWordEdit *edit, TListBox *wordList);
