...
DWORD WINAPI UnzipRawOpen(HUNZIP *);
#define UNZIPRAWOPENNAME "UnzipRawOpen"
typedef DWORD WINAPI UnzipRawOpenPtr(HUNZIP *);

DWORD WINAPI UnzipRawClose(HUNZIP);
#define UNZIPRAWCLOSENAME "UnzipRawClose"
typedef DWORD WINAPI UnzipRawClosePtr(HUNZIP);

DWORD WINAPI UnzipRawBuffer(HUNZIP, const void *, unsigned, void *, unsigned);
#define UNZIPRAWBUFFERNAME "UnzipRawBuffer"
typedef DWORD WINAPI UnzipRawBufferPtr(HUNZIP, const void *, unsigned, void *, unsigned);
