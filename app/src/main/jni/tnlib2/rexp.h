...
unsigned char* _cdecl re_comp( unsigned char* pat );

unsigned char* _cdecl re_compv( unsigned char** patv );

void _cdecl re_init_pattern( void );
unsigned _cdecl re_add_pattern( unsigned char* pat );
void _cdecl re_end_pattern( void );

int _cdecl re_exec( unsigned char* str );
